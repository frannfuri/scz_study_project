...
class LinearHeadBENDR(nn.Module):
    ...
    def load_pretrained_modules(self, encoder_file='./datasets/encoder.pt', contextualizer_file='./datasets/contextualizer.pt',
...
class BENDRClassification(nn.Module):
    ...
    def __init__(self, targets=2, samples_len=6*256, n_chn=20, encoder_h=512, contextualizer_hidden=3076, projection_head=False,
